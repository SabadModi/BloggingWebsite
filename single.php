...
<body>
    ...
    <div class="page-wrapper">
        ...
        <div class="content clearfix">
                                            ...
                                            <?php if (isset($commentsAffected) && $commentsAffected > 0) : ?>
                                                ...
                                                <?php foreach ($comments as $comment) : ?>
                                                    ...
                                                    <div class="comment clearfix">
                                                        ...
                                                        <!-- </div> -->
                                                        <!-- reply form -->
                                                        <form action="single.php?id=<?php echo $post['id']; ?>" class="reply_form clearfix" id="comment_reply_form_<?php echo $comment['id'] ?>" data-id="<?php echo $comment['id']; ?>">
            ...
            <?php else: ?>
                <h2>Please sign in to Like and Comment</h2> 
            <?php endif; ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '#submit_comment', function(e) {
                ...
                var url = "single.php?id=<?php echo $post['id']; ?>"
